...
def draw_sol(x,y):
    arcade.draw_circle_filled(200+x, 620+y, 100, arcade.color.YELLOW)


def on_draw(delta_time):
    arcade.set_background_color(arcade.color.BLUE_GRAY) # cielo
...
def main():
    arcade.open_window(1000,800,"lab3")
